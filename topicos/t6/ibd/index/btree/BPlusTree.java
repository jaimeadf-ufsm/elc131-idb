...
public abstract class BPlusTree {
     ...
     */
    public abstract ArrayList<Value> searchRange(Key lowerBound, Key upperBound);
    
    public abstract ArrayList<Value> searchSmaller(Key upperBound);

    public abstract ArrayList<Value> searchLarger(Key lowerBound);
